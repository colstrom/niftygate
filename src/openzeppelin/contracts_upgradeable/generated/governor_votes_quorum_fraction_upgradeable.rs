...
pub mod governor_votes_quorum_fraction_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(GovernorVotesQuorumFractionUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::governor_votes_quorum_fraction_upgradeable::Contract as GovernorVotesQuorumFractionUpgradeable;
