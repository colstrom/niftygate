...
pub mod token_timelock {
  ...
  impl Methods {
    #[doc = "Generated by `ethcontract`"]
    pub fn release(&self) -> self::ethcontract::dyns::DynMethodBuilder<self::ethcontract::Void> {
      self
        .instance
    ...
    #[doc = "Generated by `ethcontract`"]
    pub fn token(&self) -> self::ethcontract::dyns::DynMethodBuilder<self::ethcontract::Address> {
      self
        .instance
        .method([252, 12, 84, 106], ())
        .expect("generated call")
    }
    #[doc = "Generated by `ethcontract`"]
    pub fn release_time(
