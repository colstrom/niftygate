...
pub mod refund_escrow {
  ...
  impl Methods {
    ...
    #[doc = "Generated by `ethcontract`"]
    pub fn state(&self) -> self::ethcontract::dyns::DynMethodBuilder<u8> {
      self
        .instance
        .method([193, 157, 147, 251], ())
        .expect("generated call")
    }
    #[doc = "Generated by `ethcontract`"]
    ...
    #[doc = "Generated by `ethcontract`"]
    pub fn close(&self) -> self::ethcontract::dyns::DynMethodBuilder<self::ethcontract::Void> {
      self
        .instance
  ...
  pub mod event_data {
    ...
    impl self::ethcontract::web3::contract::tokens::Detokenize for RefundsEnabled {
      fn from_tokens(
        ...
        if tokens.len() != 0 {
          return Err(self::ethcontract::web3::contract::Error::InvalidOutputType(
            format!("Expected {} tokens, got {}: {:?}", 0, tokens.len(), tokens),
          ));
        }
        #[allow(unused_mut)]
        let mut _tokens = tokens.into_iter();
        Ok(RefundsEnabled())
      }
    }
    #[derive(Clone, Debug, Default, Eq, PartialEq)]
    ...
    impl self::ethcontract::web3::contract::tokens::Detokenize for RefundsClosed {
      fn from_tokens(
        tokens: Vec<self::ethcontract::common::abi::Token>,
      ) -> Result<Self, self::ethcontract::web3::contract::Error> {
        if tokens.len() != 0 {
