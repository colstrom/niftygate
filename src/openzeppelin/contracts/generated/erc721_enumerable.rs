...
pub mod erc721_enumerable {
  ...
  impl Methods {
    ...
    pub fn token_of_owner_by_index(
      ...
      self
        .instance
        .method([47, 116, 92, 89], (owner, index))
    ...
    pub fn is_approved_for_all(
      ...
      self
        .instance
        .method([233, 133, 233, 197], (owner, operator))
        .expect("generated call")
    }
    #[doc = "Generated by `ethcontract`"]
    pub fn token_uri(
      ...
      self
        .instance
        .method([200, 123, 86, 221], (token_id,))
        .expect("generated call")
    }
    #[doc = "Generated by `ethcontract`"]
  ...
  pub mod event_data {
    ...
    impl self::ethcontract::web3::contract::tokens::Detokenize for Transfer {
      fn from_tokens(
        ...
        let token_id = < self :: ethcontract :: U256 as self :: ethcontract :: web3 :: contract :: tokens :: Tokenizable > :: from_token (tokens . next () . unwrap ()) ? ;
    ...
    impl self::ethcontract::web3::contract::tokens::Detokenize for Approval {
      fn from_tokens(
        ...
        let mut tokens = tokens.into_iter();
        let owner = < self :: ethcontract :: Address as self :: ethcontract :: web3 :: contract :: tokens :: Tokenizable > :: from_token (tokens . next () . unwrap ()) ? ;
        let approved = < self :: ethcontract :: Address as self :: ethcontract :: web3 :: contract :: tokens :: Tokenizable > :: from_token (tokens . next () . unwrap ()) ? ;
        let token_id = < self :: ethcontract :: U256 as self :: ethcontract :: web3 :: contract :: tokens :: Tokenizable > :: from_token (tokens . next () . unwrap ()) ? ;
        Ok(Approval {
          owner,
          approved,
