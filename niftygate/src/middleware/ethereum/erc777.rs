pub mod prelude {
  pub use crate::openzeppelin::contracts::token::erc777::ERC777;
...
#[derive(Clone)]
pub struct ProvidesERC777Balance {
...
#[async_trait]
impl<State: Clone + Send + Sync + 'static> Middleware<State> for ProvidesERC777Balance {
