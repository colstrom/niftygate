...
pub mod governor_counting_simple_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(GovernorCountingSimpleUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
  ...
  impl Signatures {
    ...
    #[doc = "Returns signature for method `proposalVotes(uint256):(uint256,uint256,uint256)`."]
    #[allow(clippy::type_complexity)]
    ...
    > {
      self::ethcontract::contract::Signature::new([84, 79, 252, 156])
    }
  ...
  impl Methods {
    ...
    pub fn proposal_votes(
      ...
      self
        .instance
        .view_method([84, 79, 252, 156], (proposal_id,))
        .expect("generated call")
    }
    #[doc = "Generated by `ethcontract`"]
    pub fn cast_vote_by_sig(
...
pub use self::governor_counting_simple_upgradeable::Contract as GovernorCountingSimpleUpgradeable;
