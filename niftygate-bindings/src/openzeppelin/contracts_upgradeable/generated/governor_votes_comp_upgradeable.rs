...
pub mod governor_votes_comp_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(GovernorVotesCompUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::governor_votes_comp_upgradeable::Contract as GovernorVotesCompUpgradeable;
