...
pub mod erc1155_receiver_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(ERC1155ReceiverUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::erc1155_receiver_upgradeable::Contract as ERC1155ReceiverUpgradeable;
