...
pub mod erc721uri_storage_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(ERC721URIStorageUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::erc721uri_storage_upgradeable::Contract as ERC721URIStorageUpgradeable;
