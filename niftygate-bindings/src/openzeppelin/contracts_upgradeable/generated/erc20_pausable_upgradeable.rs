...
pub mod erc20_pausable_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(ERC20PausableUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::erc20_pausable_upgradeable::Contract as ERC20PausableUpgradeable;
