...
pub mod ierc3156_flash_lender_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(IERC3156FlashLenderUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::ierc3156_flash_lender_upgradeable::Contract as IERC3156FlashLenderUpgradeable;
