...
pub mod governor_votes_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(GovernorVotesUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::governor_votes_upgradeable::Contract as GovernorVotesUpgradeable;
