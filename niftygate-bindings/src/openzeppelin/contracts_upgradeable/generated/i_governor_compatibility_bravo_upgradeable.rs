...
pub mod i_governor_compatibility_bravo_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(IGovernorCompatibilityBravoUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::i_governor_compatibility_bravo_upgradeable::Contract as IGovernorCompatibilityBravoUpgradeable;
