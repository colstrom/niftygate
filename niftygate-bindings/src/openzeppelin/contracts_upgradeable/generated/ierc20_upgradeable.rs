...
pub mod ierc20_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(IERC20Upgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::ierc20_upgradeable::Contract as IERC20Upgradeable;
