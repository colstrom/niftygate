...
pub mod erc721_pausable_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(ERC721PausableUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::erc721_pausable_upgradeable::Contract as ERC721PausableUpgradeable;
