...
pub mod governor_compatibility_bravo_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(GovernorCompatibilityBravoUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
  ...
  impl Methods {
    ...
    pub fn proposals(
      ...
      self
        .instance
        .view_method([1, 60, 240, 139], (proposal_id,))
        .expect("generated call")
    }
    #[doc = "Generated by `ethcontract`"]
    pub fn supports_interface(
...
pub use self::governor_compatibility_bravo_upgradeable::Contract as GovernorCompatibilityBravoUpgradeable;
