...
pub mod i_governor_timelock_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(IGovernorTimelockUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::i_governor_timelock_upgradeable::Contract as IGovernorTimelockUpgradeable;
