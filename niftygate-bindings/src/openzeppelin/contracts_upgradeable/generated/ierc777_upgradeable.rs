...
pub mod ierc777_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(IERC777Upgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::ierc777_upgradeable::Contract as IERC777Upgradeable;
