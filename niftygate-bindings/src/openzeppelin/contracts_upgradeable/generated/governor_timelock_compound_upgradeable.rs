...
pub mod governor_timelock_compound_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(GovernorTimelockCompoundUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::governor_timelock_compound_upgradeable::Contract as GovernorTimelockCompoundUpgradeable;
