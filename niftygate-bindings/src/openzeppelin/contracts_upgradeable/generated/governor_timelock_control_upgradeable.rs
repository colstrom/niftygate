...
pub mod governor_timelock_control_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(GovernorTimelockControlUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::governor_timelock_control_upgradeable::Contract as GovernorTimelockControlUpgradeable;
