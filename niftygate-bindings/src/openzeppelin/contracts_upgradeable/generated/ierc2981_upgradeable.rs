...
pub mod ierc2981_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(IERC2981Upgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::ierc2981_upgradeable::Contract as IERC2981Upgradeable;
