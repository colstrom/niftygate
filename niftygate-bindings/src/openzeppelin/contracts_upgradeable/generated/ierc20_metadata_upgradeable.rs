...
pub mod ierc20_metadata_upgradeable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(IERC20MetadataUpgradeable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::ierc20_metadata_upgradeable::Contract as IERC20MetadataUpgradeable;
