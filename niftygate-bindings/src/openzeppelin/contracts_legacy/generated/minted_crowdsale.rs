...
pub mod minted_crowdsale {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(MintedCrowdsale))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::minted_crowdsale::Contract as MintedCrowdsale;
