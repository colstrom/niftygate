...
pub mod refundable_crowdsale {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(RefundableCrowdsale))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::refundable_crowdsale::Contract as RefundableCrowdsale;
