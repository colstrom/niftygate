...
pub mod allowance_crowdsale {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(AllowanceCrowdsale))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::allowance_crowdsale::Contract as AllowanceCrowdsale;
