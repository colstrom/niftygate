...
pub mod increasing_price_crowdsale {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(IncreasingPriceCrowdsale))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::increasing_price_crowdsale::Contract as IncreasingPriceCrowdsale;
