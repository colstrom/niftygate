...
pub mod erc20_detailed {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(ERC20Detailed))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::erc20_detailed::Contract as ERC20Detailed;
