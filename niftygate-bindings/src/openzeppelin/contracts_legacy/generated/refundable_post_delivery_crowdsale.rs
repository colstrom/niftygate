...
pub mod refundable_post_delivery_crowdsale {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(RefundablePostDeliveryCrowdsale))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::refundable_post_delivery_crowdsale::Contract as RefundablePostDeliveryCrowdsale;
