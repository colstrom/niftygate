...
pub mod timed_crowdsale {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(TimedCrowdsale))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::timed_crowdsale::Contract as TimedCrowdsale;
