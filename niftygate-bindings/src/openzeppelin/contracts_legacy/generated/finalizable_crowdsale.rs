...
pub mod finalizable_crowdsale {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(FinalizableCrowdsale))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::finalizable_crowdsale::Contract as FinalizableCrowdsale;
