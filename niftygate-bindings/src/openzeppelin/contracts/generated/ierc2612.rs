...
pub mod ierc2612 {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(IERC2612))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::ierc2612::Contract as IERC2612;
