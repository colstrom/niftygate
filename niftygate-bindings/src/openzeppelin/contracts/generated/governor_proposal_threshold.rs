#[allow(dead_code)]
pub mod governor_proposal_threshold {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(GovernorProposalThreshold))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::governor_proposal_threshold::Contract as GovernorProposalThreshold;
