...
pub mod governor_counting_simple {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(GovernorCountingSimple))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::governor_counting_simple::Contract as GovernorCountingSimple;
