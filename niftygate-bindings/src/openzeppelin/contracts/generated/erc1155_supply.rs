...
pub mod erc1155_supply {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(ERC1155Supply))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::erc1155_supply::Contract as ERC1155Supply;
