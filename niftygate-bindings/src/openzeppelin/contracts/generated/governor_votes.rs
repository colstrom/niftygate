...
pub mod governor_votes {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(GovernorVotes))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::governor_votes::Contract as GovernorVotes;
