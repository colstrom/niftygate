...
pub mod governor_timelock_control {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(GovernorTimelockControl))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::governor_timelock_control::Contract as GovernorTimelockControl;
