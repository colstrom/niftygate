...
pub mod i_governor {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(IGovernor))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::i_governor::Contract as IGovernor;
