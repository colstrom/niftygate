...
pub mod i_governor_timelock {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(IGovernorTimelock))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::i_governor_timelock::Contract as IGovernorTimelock;
