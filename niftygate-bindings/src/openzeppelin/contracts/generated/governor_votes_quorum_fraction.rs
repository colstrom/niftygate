...
pub mod governor_votes_quorum_fraction {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(GovernorVotesQuorumFraction))
        .field(&self.address())
        .finish()
    }
  }
  ...
  impl Methods {
    ...
    pub fn update_quorum_numerator(
      &self,
      new_quorum_numerator: self::ethcontract::U256,
    ) -> self::ethcontract::dyns::DynMethodBuilder<()> {
      self
        .instance
        .method([6, 243, 249, 230], (new_quorum_numerator,))
        .expect("generated call")
    }
    #[doc = "Generated by `ethcontract`"]
    pub fn supports_interface(
  ...
  pub mod event_data {
    ...
    pub struct QuorumNumeratorUpdated {
      ...
      pub new_quorum_numerator: self::ethcontract::U256,
    }
    impl QuorumNumeratorUpdated {
      #[doc = r" Retrieves the signature for the event this data corresponds to."]
      #[doc = r" This signature is the Keccak-256 hash of the ABI signature of"]
      #[doc = r" this event."]
      pub fn signature() -> self::ethcontract::H256 {
        self::ethcontract::H256([
          5, 83, 71, 107, 240, 46, 242, 114, 110, 140, 229, 206, 215, 141, 99, 226, 110, 96, 46,
          74, 34, 87, 177, 245, 89, 65, 142, 36, 180, 99, 57, 151,
        ])
      }
      #[doc = r" Retrieves the ABI signature for the event this data corresponds"]
      #[doc = r" to. For this event the value should always be:"]
      #[doc = r""]
      #[doc = "`QuorumNumeratorUpdated(uint256,uint256)`"]
      pub fn abi_signature() -> &'static str {
        "QuorumNumeratorUpdated(uint256,uint256)"
      }
    }
    impl self::ethcontract::tokens::Tokenize for QuorumNumeratorUpdated {
      fn from_token(
        token: self::ethcontract::common::abi::Token,
      ) -> Result<Self, self::ethcontract::tokens::Error> {
        let (old_quorum_numerator, new_quorum_numerator) =
          self::ethcontract::tokens::Tokenize::from_token(token)?;
  ...
  pub mod event_builders {
    ...
    pub struct QuorumNumeratorUpdatedBuilder(
      #[doc = r" The inner event builder."]
      pub  self::ethcontract::dyns::DynEventBuilder<self::event_data::QuorumNumeratorUpdated>,
    );
    impl QuorumNumeratorUpdatedBuilder {
      #[doc = r" Sets the starting block from which to stream logs for."]
      #[doc = r""]
      #[doc = r" If left unset defaults to the latest block."]
      #[allow(clippy::wrong_self_convention)]
      ...
      pub async fn query(
        ...
        std::vec::Vec<self::ethcontract::Event<self::event_data::QuorumNumeratorUpdated>>,
        self::ethcontract::errors::EventError,
      > {
        (self.0).query().await
      }
      ...
      pub fn stream(
        ...
        Item = std::result::Result<
          self::ethcontract::StreamEvent<self::event_data::QuorumNumeratorUpdated>,
          self::ethcontract::errors::EventError,
        >,
      > {
        (self.0).stream()
  ...
  pub enum Event {
    ...
    QuorumNumeratorUpdated(self::event_data::QuorumNumeratorUpdated),
...
pub use self::governor_votes_quorum_fraction::Contract as GovernorVotesQuorumFraction;
