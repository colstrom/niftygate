...
pub mod erc1155_pausable {
  ...
  impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
      f.debug_tuple(stringify!(ERC1155Pausable))
        .field(&self.address())
        .finish()
    }
  }
...
pub use self::erc1155_pausable::Contract as ERC1155Pausable;
